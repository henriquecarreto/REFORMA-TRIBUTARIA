export const siteConfig = {
  ...
  facebookUrl: "https://www.facebook.com/profile.php?id=61592870490229",
  facebookHandle: "Fiscal Simplificado",
  guaranteeDays: 7,

  // Legal
  copyright: "© 2026 Fiscal Simplificado. Todos os direitos reservados.",
  disclaimer: "Aviso legal: Este produto é um recurso educativo digital comercializado como acervo complementar. As marcas e plataformas de checkout terceiras mencionadas são de propriedade de seus respectivos titulares.",
